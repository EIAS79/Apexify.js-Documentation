...
try{
 for(const state of states){
  ...
  const sourceHref=await page.$eval('[data-doc4-component="SourceLink"]',e=>e.getAttribute('href')||'');if(!sourceHref.includes('69d40cf40ba992ad2bdec457c6c7217f5df55cd1'))throw new Error(`${state.name} source link is not commit-pinned`);
