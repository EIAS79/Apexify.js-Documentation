...
try{
 for(const state of states){
  ...
  const sourceHref=await page.$eval('[data-doc4-component="SourceLink"]',e=>e.getAttribute('href')||'');if(!sourceHref.includes('f57bb82743c8f71bbe7e519d060010f970b06ef9'))throw new Error(`${state.name} source link is not commit-pinned`);
