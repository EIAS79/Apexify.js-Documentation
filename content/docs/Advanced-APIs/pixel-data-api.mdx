...
Built-in pixel filters (e.g. **sepia**, **grayscale**) follow the same color math as the rest of the pipeline; sepia uses consistent RGB channel mixing across the output.
