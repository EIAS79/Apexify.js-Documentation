...
The showcase site depends on **`apexify.js`** `^5.3.16` (see root `package.json`). Entries below mirror the repository **`CHANGELOG.md`** through **[5.3.16]** and earlier releases.
