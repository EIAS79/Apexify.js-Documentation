...
import { renderAllCanvasBackgroundPipelinePicks } from '../background/canvasBackgroundShowcasePicks';
import { chartsLegendPanel, chartsLegendPosition, renderAllShowcasePicks } from '../charts/chartsShowcasePicks';
